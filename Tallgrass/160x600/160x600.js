...
}).prototype = getMCSymbolPrototype(lib.snow_1, new cjs.Rectangle(0,0,160,600), null);
...
}).prototype = getMCSymbolPrototype(lib.image7_1, new cjs.Rectangle(0,0,160,600), null);
...
}).prototype = getMCSymbolPrototype(lib.image6_1, new cjs.Rectangle(0,0,160,600), null);
...
}).prototype = getMCSymbolPrototype(lib.image5_1, new cjs.Rectangle(0,0,160,600), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance_4.setTransform(220.05,132.45,0.2,0.2,-144.503,0,0,84.5,467.7);
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(49).to({_off:false},0).to({regY:467.8,scaleX:1,scaleY:1,rotation:-144.5034,x:160.05,y:152.4},10).to({regY:467.7,scaleX:0.2,scaleY:0.2,rotation:-144.503,x:220.05,y:132.45},10).wait(201));
...
p.nominalBounds = new cjs.Rectangle(-93,200,413,420);
// library properties:
lib.properties = {
	id: 'A521801A3730470EBA3B94AB6E2FE8A0',
	width: 160,
	height: 600,
	fps: 30,
	color: "#FFFFFF",
...
an.compositions['A521801A3730470EBA3B94AB6E2FE8A0'] = {
