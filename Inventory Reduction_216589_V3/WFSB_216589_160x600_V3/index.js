...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(39).to({_off:false},0).to({y:300},14,cjs.Ease.get(1)).wait(187));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(34).to({_off:false},0).to({x:80,y:294},14,cjs.Ease.get(1)).wait(192));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(29).to({_off:false},0).to({x:80},14,cjs.Ease.get(1)).wait(197));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(23).to({_off:false},0).to({y:300,alpha:1},14,cjs.Ease.get(1)).wait(203));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(18).to({_off:false},0).to({y:300,alpha:1},14,cjs.Ease.get(1)).wait(208));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(13).to({_off:false},0).to({y:300,alpha:1},14,cjs.Ease.get(1)).wait(213));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(6).to({_off:false},0).to({y:300,alpha:1},14,cjs.Ease.get(1)).wait(220));

	// InventoryReduction.png
	this.instance_7 = new lib.InventoryReduction_1("synched",0);
	this.instance_7.setTransform(80,220);

	this.timeline.addTween(cjs.Tween.get(this.instance_7).to({y:300},14,cjs.Ease.get(1)).wait(226));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(118).to({_off:false},0).to({alpha:1},12,cjs.Ease.get(1)).wait(110));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(30).to({_off:false},0).to({startPosition:0},14,cjs.Ease.get(1)).wait(61).to({startPosition:0},0).to({alpha:0},12).to({_off:true},1).wait(122));
...
p.nominalBounds = new cjs.Rectangle(-163.3,-80,323.3,734);


// stage content:
(lib.WFSB_216589_160x600_V3 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
