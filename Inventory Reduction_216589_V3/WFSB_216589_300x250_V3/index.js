...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(31).to({_off:false},0).to({y:300},14,cjs.Ease.get(1)).wait(117));

	// CTA.png
	this.instance_1 = new lib.CTA_1("synched",0);
	this.instance_1.setTransform(236.65,300);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(25).to({_off:false},0).to({x:80},14,cjs.Ease.get(1)).wait(123));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(19).to({_off:false},0).to({x:80},14,cjs.Ease.get(1)).wait(129));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(124).to({_off:false},0).to({y:300,alpha:1},14,cjs.Ease.get(1)).wait(24));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(119).to({_off:false},0).to({y:300,alpha:1},14,cjs.Ease.get(1)).wait(29));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(13).to({_off:false},0).to({y:300,alpha:1},14,cjs.Ease.get(1)).wait(78).to({startPosition:0},0).to({alpha:0},12).to({_off:true},1).wait(44));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(6).to({_off:false},0).to({y:300,alpha:1},14,cjs.Ease.get(1)).wait(85).to({startPosition:0},0).to({alpha:0},12).to({_off:true},1).wait(44));

	// InventoryReduction.png
	this.instance_7 = new lib.InventoryReduction_1("synched",0);
	this.instance_7.setTransform(80,220);

	this.timeline.addTween(cjs.Tween.get(this.instance_7).to({y:300},14,cjs.Ease.get(1)).wait(148));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(118).to({_off:false},0).to({alpha:1},12,cjs.Ease.get(1)).wait(32));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(30).to({_off:false},0).to({alpha:1},14,cjs.Ease.get(1)).wait(61).to({startPosition:0},0).to({alpha:0},12).to({_off:true},1).wait(44));

	// BG.jpg
	this.instance_10 = new lib.bg("synched",0);
	this.instance_10.setTransform(80,300);

	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(162));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-160.6,-80,617.3,384);


// stage content:
(lib.WFSB_216589_300x250_V3 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
