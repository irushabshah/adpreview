...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(39).to({_off:false},0).to({y:300},14,cjs.Ease.get(1)).wait(149));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(34).to({_off:false},0).to({x:80},14,cjs.Ease.get(1)).wait(154));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(29).to({_off:false},0).to({x:80},14,cjs.Ease.get(1)).wait(159));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(23).to({_off:false},0).to({y:300,alpha:1},14,cjs.Ease.get(1)).wait(165));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(18).to({_off:false},0).to({y:300,alpha:1},14,cjs.Ease.get(1)).wait(170));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(13).to({_off:false},0).to({y:300,alpha:1},14,cjs.Ease.get(1)).wait(175));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(6).to({_off:false},0).to({y:300,alpha:1},14,cjs.Ease.get(1)).wait(182));

	// InventoryReduction.png
	this.instance_7 = new lib.InventoryReduction_1("synched",0);
	this.instance_7.setTransform(80,166);

	this.timeline.addTween(cjs.Tween.get(this.instance_7).to({y:300},14,cjs.Ease.get(1)).wait(188));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(36).to({_off:false},0).to({alpha:1},12,cjs.Ease.get(1)).wait(154));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(30).to({_off:false},0).to({startPosition:0},14,cjs.Ease.get(1)).wait(158));
...
// stage content:
(lib.WFSB_216589_300x600_V3 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
