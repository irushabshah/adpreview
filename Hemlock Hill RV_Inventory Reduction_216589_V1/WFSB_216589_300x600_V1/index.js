...
if (reversed == null) { reversed = false; }
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).wait(201).call(this.frame_201).wait(479));
	...
	this.timeline.addTween(cjs.Tween.get(this.ad_clickBtn).to({_off:true},202).wait(478));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(39).to({_off:false},0).to({regX:220.7,regY:33.6,scaleX:0.5274,scaleY:0.5274,x:273.1,y:519.95},10,cjs.Ease.get(1)).to({_off:true},153).wait(478));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(34).to({_off:false},0).to({regX:220.6,regY:33.6,scaleX:1.0548,scaleY:1.0548,x:276.65},10,cjs.Ease.get(1)).to({_off:true},158).wait(478));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(23).to({_off:false},0).to({regX:220.7,regY:33.6,scaleX:0.5274,scaleY:0.5274,x:54.1,y:24.95},10,cjs.Ease.get(1)).to({_off:true},169).wait(478));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(18).to({_off:false},0).to({regX:220.6,regY:33.6,scaleX:1.0548,scaleY:1.0548,x:28.65},10,cjs.Ease.get(1)).to({_off:true},174).wait(478));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(23).to({_off:false},0).to({regX:220.7,regY:33.6,scaleX:0.5274,scaleY:0.5274,x:283.1,y:116.95},10,cjs.Ease.get(1)).to({_off:true},169).wait(478));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(18).to({_off:false},0).to({regX:220.6,regY:33.6,scaleX:1.0548,scaleY:1.0548,x:267.65},10,cjs.Ease.get(1)).to({_off:true},174).wait(478));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(28).to({_off:false},0).to({y:572.15,alpha:1},9,cjs.Ease.get(1)).to({_off:true},165).wait(478));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(19).to({_off:false},0).to({y:567.7,alpha:1},9,cjs.Ease.get(1)).to({_off:true},174).wait(478));

	// Placeholder.png
	this.instance_8 = new lib.Placeholder_1("synched",0);
	this.instance_8.setTransform(80,300);
	this.instance_8.alpha = 0;
	this.instance_8._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(30).to({_off:false},0).to({alpha:1},10).to({_off:true},401).wait(239));

	// IMG1.png
	this.instance_9 = new lib.img1();
	this.instance_9.setTransform(80,304);
	this.instance_9.alpha = 0;
	this.instance_9._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(18).to({_off:false},0).to({alpha:1},9).to({_off:true},175).wait(478));

	// DATE.png
	this.instance_10 = new lib.DATE_1();
	this.instance_10.setTransform(80,300);
	this.instance_10.alpha = 0;
	this.instance_10._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(20).to({_off:false},0).to({alpha:1},9).to({_off:true},173).wait(478));

	// 46.png
	this.instance_11 = new lib._46_1();
	this.instance_11.setTransform(80,280);
	this.instance_11.alpha = 0;
	this.instance_11._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(11).to({_off:false},0).to({y:300,alpha:1},9,cjs.Ease.get(1)).to({_off:true},182).wait(478));

	// $150.png
	this.instance_12 = new lib._150_1();
	this.instance_12.setTransform(80,270);
	this.instance_12.alpha = 0;
	this.instance_12._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(9).to({_off:false},0).to({y:300,alpha:1},9,cjs.Ease.get(1)).to({_off:true},184).wait(478));

	// AdditionalDiscounts.png
	this.instance_13 = new lib.AdditionalDiscounts_1("synched",0);
	this.instance_13.setTransform(80,294);
	this.instance_13.alpha = 0;
	this.instance_13._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(9).to({_off:false},0).to({y:300,alpha:1},9).wait(662));

	// InventoryReduction.png
	this.instance_14 = new lib.InventoryReduction_1();
	this.instance_14.setTransform(150,90.6,0.6,0.6,0,0,0,70.1,-209.3);
	this.instance_14.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_14).to({regX:70,regY:-209.5,scaleX:1,scaleY:1,y:90.5,alpha:1},9,cjs.Ease.get(1)).to({_off:true},193).wait(478));

	// Corner
	this.instance_15 = new lib.Corner();
	this.instance_15.setTransform(156.9,600.85,0.7895,0.7895,180);

	this.instance_16 = new lib.Corner();
	this.instance_16.setTransform(144,-2,0.7895,0.7895);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_16},{t:this.instance_15}]}).to({state:[]},202).wait(478));
	...
	this.timeline.addTween(cjs.Tween.get(this.shape).wait(9).to({_off:false},0).wait(1).to({y:661.275},0).wait(1).to({y:627.975},0).wait(1).to({y:599.075},0).wait(1).to({y:574.625},0).wait(1).to({y:554.625},0).wait(1).to({y:539.075},0).wait(1).to({y:527.975},0).wait(1).to({y:521.275},0).wait(1).to({y:519.075},0).to({_off:true},184).wait(478));

	// BG.jpg
	this.instance_17 = new lib.Background();
	this.instance_17.setTransform(80,300);

	this.timeline.addTween(cjs.Tween.get(this.instance_17).to({_off:true},202).wait(478));
...
// stage content:
(lib.WFSB_216589_300x600_V1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
