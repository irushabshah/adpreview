...
}).prototype = getMCSymbolPrototype(lib.Logo_1, new cjs.Rectangle(-80,-568,1024,90), null);
...
}).prototype = getMCSymbolPrototype(lib.InventoryReduction_1, new cjs.Rectangle(-80,-300,1024,90), null);
...
}).prototype = getMCSymbolPrototype(lib.img1, new cjs.Rectangle(-80,-300,1024,90), null);
...
}).prototype = getMCSymbolPrototype(lib.DATE_1, new cjs.Rectangle(-80,-300,1024,90), null);
...
}).prototype = getMCSymbolPrototype(lib.Cta, new cjs.Rectangle(-236,-581,1024,90), null);
...
}).prototype = getMCSymbolPrototype(lib.Background, new cjs.Rectangle(-80,-300,1024,90), null);
...
}).prototype = getMCSymbolPrototype(lib._46_1, new cjs.Rectangle(-80,-300,1024,90), null);
...
}).prototype = getMCSymbolPrototype(lib._150_1, new cjs.Rectangle(-80,-300,1024,90), null);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(23).to({startPosition:0},0).to({y:-87.3},96).wait(1));
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(509.6,16.85,0.1972,0.1972,0,0,0,221.6,35);
	...
	this.instance_2.setTransform(172.75,73.55,0.3753,0.3753,0,0,0,219.3,34.1);
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(59).to({_off:false},0).to({regX:220.5,regY:33.5,scaleX:1.063,scaleY:1.063,x:172.95,y:73.5},10,cjs.Ease.get(1)).wait(171));
	...
	this.instance_4.setTransform(869.45,45.85);
	this.instance_4.alpha = 0;
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(36).to({_off:false},0).to({alpha:1},9).wait(195));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(45).to({_off:false},0).to({y:581.15,alpha:1},9,cjs.Ease.get(1)).wait(186));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(27).to({_off:false},0).to({y:567.7,alpha:1},9,cjs.Ease.get(1)).wait(204));

	// Placeholder_Image_s.png
	this.instance_7 = new lib.Placeholder_Image_s_1("synched",0,false);
	this.instance_7.setTransform(633.65,115.6,1.584,1.584);
	this.instance_7._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(87).to({_off:false},0).wait(153));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(18).to({_off:false},0).to({alpha:1},9).wait(48).to({alpha:0},11).to({_off:true},1).wait(153));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(18).to({_off:false},0).to({alpha:1},9).wait(213));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(9).to({_off:false},0).to({y:300,alpha:1},9,cjs.Ease.get(1)).wait(222));
	...
	this.instance_13.setTransform(82,44,0.6,0.6,0,0,0,2.1,-255.9);
	this.instance_13.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_13).to({regX:2,regY:-256,scaleX:1,scaleY:1,alpha:1},9,cjs.Ease.get(1)).wait(231));

	// Corner
	this.instance_14 = new lib.Corner();
	this.instance_14.setTransform(93.75,91.1,0.4737,0.4737,180);

	this.instance_15 = new lib.Corner();
	this.instance_15.setTransform(931,-2,0.4737,0.4737);
	...
	this.shape.setTransform(1244.1814,50.6832,2.6999,1);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFB500").s().p("EghvAMnIAA5NMBDfAAAIAAZNg");
	this.shape_1.setTransform(1162.325,50.675);
	this.shape_1._off = true;

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape,p:{x:1244.1814}}]},9).to({state:[{t:this.shape_1}]},1).to({state:[{t:this.shape_1}]},1).to({state:[{t:this.shape_1}]},1).to({state:[{t:this.shape_1}]},1).to({state:[{t:this.shape_1}]},1).to({state:[{t:this.shape_1}]},1).to({state:[{t:this.shape_1}]},1).to({state:[{t:this.shape_1}]},1).to({state:[{t:this.shape,p:{x:854.1814}}]},1).wait(222));
	this.timeline.addTween(cjs.Tween.get(this.shape_1).wait(10).to({_off:false},0).wait(1).to({x:1090.075},0).wait(1).to({x:1027.525},0).wait(1).to({x:974.525},0).wait(1).to({x:931.225},0).wait(1).to({x:897.525},0).wait(1).to({x:873.425},0).wait(1).to({x:858.975},0).to({_off:true},1).wait(222));
...
p.nominalBounds = new cjs.Rectangle(-1,-30,1461.2,259.2);


// stage content:
(lib.WFSB_216589_1024x90_V1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
