...
p.nominalBounds = new cjs.Rectangle(0,0,315,50);
...
}).prototype = getMCSymbolPrototype(lib.Logo_1, new cjs.Rectangle(-80,-568,320,50), null);
...
}).prototype = getMCSymbolPrototype(lib.InventoryReduction_1, new cjs.Rectangle(-80,-300,320,50), null);
...
}).prototype = getMCSymbolPrototype(lib.DATE_1, new cjs.Rectangle(-80,-300,315,50), null);
...
}).prototype = getMCSymbolPrototype(lib.Cta, new cjs.Rectangle(-236,-581,320,50), null);
...
}).prototype = getMCSymbolPrototype(lib.bg, new cjs.Rectangle(-160,-25,320,50), null);
...
}).prototype = getMCSymbolPrototype(lib._46_1, new cjs.Rectangle(-80,-300,315,50), null);
...
}).prototype = getMCSymbolPrototype(lib._150_1, new cjs.Rectangle(-80,-300,320,50), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance_2.setTransform(87.85,39.75,0.1098,0.1098,0,0,0,221,33.7);
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(36).to({_off:false},0).to({regX:220.7,regY:33.6,scaleX:0.3109,scaleY:0.3109,x:87.9},10,cjs.Ease.get(1)).wait(194));
	...
	// DATE.png
	this.instance_5 = new lib.DATE_1();
	this.instance_5.setTransform(80,300);
	this.instance_5.alpha = 0;
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(98).to({_off:false},0).to({alpha:1},9).wait(133));

	// 46.png
	this.instance_6 = new lib._46_1();
	this.instance_6.setTransform(80,280);
	this.instance_6.alpha = 0;
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(89).to({_off:false},0).to({y:300,alpha:1},9,cjs.Ease.get(1)).wait(142));

	// $150.png
	this.instance_7 = new lib._150_1();
	this.instance_7.setTransform(80,270);
	this.instance_7.alpha = 0;
	this.instance_7._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(9).to({_off:false},0).to({y:300,alpha:1},9,cjs.Ease.get(1)).wait(62).to({y:350,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(151));

	// InventoryReduction.png
	this.instance_8 = new lib.InventoryReduction_1();
	this.instance_8.setTransform(55,23,0.6,0.6,0,0,0,-24.9,-276.9);
	this.instance_8.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_8).to({regX:-25,regY:-277,scaleX:1,scaleY:1,alpha:1},9,cjs.Ease.get(1)).wait(231));

	// Corner
	this.instance_9 = new lib.Corner();
	this.instance_9.setTransform(71,54.95,0.3601,0.3601,180);

	this.instance_10 = new lib.Corner();
	this.instance_10.setTransform(249,-3,0.3601,0.3601);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_10},{t:this.instance_9}]}).wait(240));

	// rect
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFB500").s().p("AsfEsIAApXIY/AAIAAJXg");
	this.shape.setTransform(379.159,24.7574,0.6723,1);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFB500").s().p("AoZEsIAApXIQzAAIAAJXg");
	this.shape_1.setTransform(362.175,24.75);
	this.shape_1._off = true;

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape,p:{x:379.159}}]},9).to({state:[{t:this.shape_1}]},1).to({state:[{t:this.shape_1}]},1).to({state:[{t:this.shape_1}]},1).to({state:[{t:this.shape_1}]},1).to({state:[{t:this.shape_1}]},1).to({state:[{t:this.shape_1}]},1).to({state:[{t:this.shape_1}]},1).to({state:[{t:this.shape_1}]},1).to({state:[{t:this.shape,p:{x:298.159}}]},1).wait(222));
	this.timeline.addTween(cjs.Tween.get(this.shape_1).wait(10).to({_off:false},0).wait(1).to({x:347.175},0).wait(1).to({x:334.175},0).wait(1).to({x:323.175},0).wait(1).to({x:314.175},0).wait(1).to({x:307.175},0).wait(1).to({x:302.175},0).wait(1).to({x:299.175},0).to({_off:true},1).wait(222));
...
p.nominalBounds = new cjs.Rectangle(-2.3,-30,435.3,130);


// stage content:
(lib.WFSB_216589_320x50 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
