...
}).prototype = getMCSymbolPrototype(lib.Logo_1, new cjs.Rectangle(-80,-568,300,250), null);
...
}).prototype = getMCSymbolPrototype(lib.InventoryReduction_1, new cjs.Rectangle(-80,-300,300,250), null);
...
}).prototype = getMCSymbolPrototype(lib.img1, new cjs.Rectangle(-80,-300,300,250), null);
...
}).prototype = getMCSymbolPrototype(lib.DATE_1, new cjs.Rectangle(-80,-300,300,250), null);
...
}).prototype = getMCSymbolPrototype(lib.Cta, new cjs.Rectangle(-236,-581,300,250), null);
...
}).prototype = getMCSymbolPrototype(lib.background, new cjs.Rectangle(-150,-125,300,250), null);
...
}).prototype = getMCSymbolPrototype(lib._46_1, new cjs.Rectangle(-80,-300,300,250), null);
...
}).prototype = getMCSymbolPrototype(lib._150_1, new cjs.Rectangle(-80,-300,300,250), null);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.ad_clickBtn).wait(162));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(51).to({_off:false},0).to({regX:220.7,regY:33.6,scaleX:0.5274,scaleY:0.5274,x:161.6,y:209.95},10,cjs.Ease.get(1)).wait(101));

	// glitter 1 copy 2
	this.instance_1 = new lib.Sparkle_1();
	this.instance_1.setTransform(6.1,24.95,0.5274,0.5274,0,0,0,220.7,33.6);
	this.instance_1.alpha = 0;
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(51).to({_off:false},0).to({alpha:1},10).wait(101));

	// glitter 1 copy 3
	this.instance_2 = new lib.Sparkle_1();
	this.instance_2.setTransform(17.2,156,0.8438,0.8438,0,0,0,220.6,33.6);
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(46).to({_off:false},0).to({scaleX:1.0548,scaleY:1.0548,x:7.15,y:156.05},10).wait(106));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(51).to({_off:false},0).to({regX:220.7,regY:33.6,scaleX:0.5274,scaleY:0.5274,x:293.1,y:88.95},10,cjs.Ease.get(1)).wait(101));

	// glitter 1
	this.instance_4 = new lib.Sparkle_1();
	this.instance_4.setTransform(282.5,39.55,0.3724,0.3724,0,0,0,220.5,33.5);
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(46).to({_off:false},0).to({regX:220.6,regY:33.6,scaleX:1.0548,scaleY:1.0548,x:294.65},10,cjs.Ease.get(1)).wait(106));

	// Cta
	this.instance_5 = new lib.Cta();
	this.instance_5.setTransform(235.75,600.05);
	this.instance_5.alpha = 0;
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(28).to({_off:false},0).to({y:583.15,alpha:1},9,cjs.Ease.get(1)).wait(125));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(19).to({_off:false},0).to({y:567.7,alpha:1},9,cjs.Ease.get(1)).wait(134));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(81).to({_off:false},0).to({alpha:1},10).wait(71));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(18).to({_off:false},0).to({alpha:1},9).wait(44).to({alpha:0},9).to({_off:true},1).wait(81));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(52).to({_off:false},0).to({alpha:1},9).wait(101));

	// 46.png
	this.instance_10 = new lib._46_1();
	this.instance_10.setTransform(80,293);
	this.instance_10.alpha = 0;
	this.instance_10._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(15).to({_off:false},0).to({y:300,alpha:1},9,cjs.Ease.get(1)).wait(138));

	// $150.png
	this.instance_11 = new lib._150_1();
	this.instance_11.setTransform(80,293);
	this.instance_11.alpha = 0;
	this.instance_11._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(13).to({_off:false},0).to({y:300,alpha:1},9,cjs.Ease.get(1)).wait(140));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(9).to({_off:false},0).to({y:300,alpha:1},9).wait(25).to({startPosition:0},0).to({alpha:0},8).to({_off:true},1).wait(110));

	// InventoryReduction.png
	this.instance_13 = new lib.InventoryReduction_1();
	this.instance_13.setTransform(155,43,0.6,0.6,0,0,0,75.1,-256.9);
	this.instance_13.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_13).to({regX:75,regY:-257,scaleX:1,scaleY:1,alpha:1},9,cjs.Ease.get(1)).wait(153));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_15},{t:this.instance_14}]}).wait(162));

	// rect
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFB500").s().p("A4/E7IAAp1MAx/AAAIAAJ1g");
	this.shape.setTransform(148.4524,287.6074);
	this.shape._off = true;

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(9).to({_off:false},0).wait(1).to({x:148.45,y:275},0).wait(1).to({y:263.9},0).wait(1).to({y:254.25},0).wait(1).to({y:246.1},0).wait(1).to({y:239.45},0).wait(1).to({y:234.25},0).wait(1).to({y:230.55},0).wait(1).to({y:228.35},0).wait(1).to({x:148.4524,y:227.6074},0).wait(144));
...
p.nominalBounds = new cjs.Rectangle(-33.5,-7,366.7,326.1);


// stage content:
(lib.WFSB_216589_300x250_V1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
