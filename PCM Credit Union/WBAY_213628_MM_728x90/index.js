...
if (reversed == null) { reversed = false; }
	...
	this.shape_3.setTransform(6.7703,18.7279,0.8099,0.8099,0,0,180);
	...
	this.shape_4.setTransform(6.3847,18.6064,0.8099,0.8099,0,0,180);
	...
	this.shape_5.setTransform(3.956,16.2914,0.8099,0.8099,0,0,180);

	this.instance = new lib.ClipGroup();
	this.instance.setTransform(-50.35,-27.15,0.8099,0.8099,0,0,180,27.4,26.3);
	...
	this.shape_6.setTransform(28.4933,-25.0678,0.8099,0.8099,0,0,180);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#818181").s().p("AgFgTIALABQgEASgBAUQgGgcAAgLg");
	this.shape_7.setTransform(-19.6928,5.2229,0.8099,0.8099,0,0,180);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#CCCCCC").s().p("AgKgJQAAgFADgBIASAAIAAAPIgPAAIgDAQQgDgPAAgKg");
	this.shape_8.setTransform(69.0104,7.5919,0.8099,0.8099,0,0,180);
	...
	this.shape_9.setTransform(24.2032,13.7065,0.8099,0.8099,0,0,180);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#676767").s().p("AgPgSIASABQAIADAAAGIAAANIAFAOg");
	this.shape_10.setTransform(-67.031,-20.0861,0.8099,0.8099,0,0,180);
	...
	this.shape_11.setTransform(31.4113,-16.5024,0.8099,0.8099,0,0,180);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#E5E5E5").s().p("AiQgOIAAgOIEhAtIAAAMg");
	this.shape_12.setTransform(-30.0392,-50.6393,0.8099,0.8099,0,0,180);
	...
	this.shape_13.setTransform(8.8172,-51.2669,0.8099,0.8099,0,0,180);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#676767").s().p("AABATIgQgBQgBgGABgKIAVADQgCAMAEAMQgEgDgDgHgAgIgSQADgJAHgBIAPAKIgCACg");
	this.shape_14.setTransform(-61.5278,-7.5531,0.8099,0.8099,0,0,180);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#818181").s().p("AgwACIAVAAQAPAAAKgHIApgsQAhgkhIBbQgJAKgQAAQAFALALAhQgUgmgTgUg");
	this.shape_15.setTransform(-43.3441,1.8245,0.8099,0.8099,0,0,180);

	this.instance_1 = new lib.ClipGroup_1();
	this.instance_1.setTransform(-30.25,-42.1,0.8099,0.8099,0,0,180,28.9,26.8);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f("#FFFFFF").s().p("ACQAmIhIglIAGALQiQgiiUgWQDQAIBMARQB2AyAbAOg");
	this.shape_16.setTransform(-61.5844,-14.2144,0.8099,0.8099,0,0,180);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#989898").s().p("AAPAjIiGgtQgXgJAAgfIEdBZIAAAAIgFAMg");
	this.shape_17.setTransform(-47.6746,-14.0525,0.8099,0.8099,0,0,180);
	...
	this.shape_18.setTransform(-23.9465,-20.3696,0.8099,0.8099,0,0,180);
	...
	this.shape_22.setTransform(-51.6633,-7.4114,0.8099,0.8099,0,0,180);

	this.shape_23 = new cjs.Shape();
	this.shape_23.graphics.f("#FFFFFF").s().p("AgpAXQgggHgbgrQgHgJANAAQAvADA3AHQA5AHAgAHQgFAVALAZQgLADgIAAQg8gEhBgKg");
	this.shape_23.setTransform(-50.9456,-7.0469,0.8099,0.8099,0,0,180);
	...
	this.shape_24.setTransform(-75.9044,-2.7929,0.8099,0.8099,0,0,180);
	...
	this.shape_25.setTransform(-73.3811,-2.6735,0.8099,0.8099,0,0,180);

	this.instance_2 = new lib.ClipGroup_2();
	this.instance_2.setTransform(-72.3,-3.05,0.8099,0.8099,0,0,180,24,22.8);

	this.shape_26 = new cjs.Shape();
	this.shape_26.graphics.f("#818181").s().p("AhNANQAVgjASgEIAFAEQAFACAKAAQB7AEgfAEIhXgBQgSABgKAFQgSAIgSAaQgFgFAFgJg");
	this.shape_26.setTransform(-54.5918,3.2792,0.8099,0.8099,0,0,180);
	...
	this.shape_27.setTransform(-66.9226,9.7178,0.8099,0.8099,0,0,180);

	this.shape_28 = new cjs.Shape();
	this.shape_28.graphics.f("#989898").s().p("AgXAFQACgEAtgRIgaAhg");
	this.shape_28.setTransform(-58.2032,5.4457,0.8099,0.8099,0,0,180);

	this.shape_29 = new cjs.Shape();
	this.shape_29.graphics.f("#676767").s().p("AgWARQgCgGAZgcQgKAVADAGQAGADAYAEIgcABIgSgBg");
	this.shape_29.setTransform(-51.0906,5.9113,0.8099,0.8099,0,0,180);

	this.shape_30 = new cjs.Shape();
	this.shape_30.graphics.f("#FFFFFF").s().p("AgNAFQgBgIAPgIQANAEAAAJQgBAKgKAAIgDAAQgMAAgBgHg");
	this.shape_30.setTransform(-53.0807,5.5512,0.8099,0.8099,0,0,180);
	...
	this.shape_31.setTransform(-34.4632,13.3016,0.8099,0.8099,0,0,180);

	this.instance_3 = new lib.ClipGroup_3();
	this.instance_3.setTransform(13.55,2.65,0.8099,0.8099,0,0,180,66,10.8);
	...
	this.shape_32.setTransform(14.849,-20.6974,0.8099,0.8099,0,0,180);
	...
	this.shape_33.setTransform(24.3464,12.8157,0.8099,0.8099,0,0,180);

	this.shape_34 = new cjs.Shape();
	this.shape_34.graphics.f("#818181").s().p("Ai7gNQAGAHAOABIErgHIAAALIkuAPQgQgGgBgVgACdgMIAfgBQAAAKgIgBIgXACg");
	this.shape_34.setTransform(48.7632,-14.8016,0.8099,0.8099,0,0,180);
	...
	this.shape_35.setTransform(47.4763,-24.8562,0.8099,0.8099,0,0,180);
	...
	this.shape_36.setTransform(-6.5929,-22.7993,0.8099,0.8099,0,0,180);
	...
	this.shape_37.setTransform(-8.2173,-12.2541,0.8099,0.8099,0,0,180);
...
p.nominalBounds = new cjs.Rectangle(-91.2,-63.8,163.5,96.5);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(10).to({startPosition:10},0).to({_off:true},1).wait(60).to({_off:false,startPosition:71},0).wait(88).to({startPosition:159},0).to({_off:true},1).wait(6).to({_off:false,startPosition:166},0).wait(2));
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.ad_clickBtn).wait(392));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(52).to({_off:false},0).to({x:280.65,alpha:1},7).wait(333));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(38).to({_off:false},0).to({alpha:1},9).wait(345));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(45).to({_off:false},0).to({alpha:1},9).wait(338));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(29).to({_off:false},0).to({alpha:1},9).wait(354));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(289).to({_off:false},0).to({x:106.4,alpha:1},9,cjs.Ease.get(1)).wait(88).to({startPosition:0},0).to({alpha:0},4).to({_off:true},1).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(196).to({_off:false},0).to({x:70.1,alpha:1},9,cjs.Ease.get(1)).to({_off:true},84).wait(103));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(95).to({_off:false},0).to({x:108.15,alpha:1},12,cjs.Ease.get(1)).wait(77).to({startPosition:0},0).to({alpha:0},6).to({_off:true},1).wait(201));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(14).to({_off:false},0).to({x:73.75,alpha:1},9,cjs.Ease.get(1)).wait(66).to({startPosition:0},0).to({alpha:0},5,cjs.Ease.get(1)).to({_off:true},1).wait(297));

	// PIC4
	this.instance_8 = new lib.Symbol1_1("synched",71);
	this.instance_8.setTransform(384.15,43.3,0.48,0.48,0,0,0,0.1,0.2);
	this.instance_8.alpha = 0;
	this.instance_8._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(289).to({_off:false},0).to({x:516.15,alpha:1,startPosition:166},89,cjs.Ease.get(1)).wait(8).to({startPosition:6},0).to({alpha:0,startPosition:10},4).to({_off:true},1).wait(1));

	// PIC3
	this.instance_9 = new lib.Tween12("synched",0);
	this.instance_9.setTransform(518.25,54.8,0.6925,0.6925);
	this.instance_9.alpha = 0;
	this.instance_9._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(196).to({_off:false},0).to({regX:0.1,regY:0.1,x:513.4,y:54.85,alpha:1},5).to({regX:0,regY:0,x:411.3,y:54.8},86).wait(1).to({startPosition:0},0).to({alpha:0},5).to({_off:true},1).wait(98));

	// PIC2
	this.instance_10 = new lib.PIC2();
	this.instance_10.setTransform(366.6,45.2,0.3635,0.3635,0,0,0,130.6,83.2);
	this.instance_10._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(96).to({_off:false},0).to({x:510.95},95).wait(1).to({x:516.95,alpha:0},3).to({_off:true},1).wait(196));

	// PIC1
	this.instance_11 = new lib.pic1();
	this.instance_11.setTransform(316.6,45.2,0.3635,0.3635,0,0,0,115.5,110.2);
	this.instance_11.alpha = 0;
	this.instance_11._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(9).to({_off:false},0).to({regX:115.7,regY:110.4,scaleX:0.3634,scaleY:0.3634,x:328.7,y:45.25,alpha:1},5).to({regX:115.5,regY:110.2,scaleX:0.3635,scaleY:0.3635,x:523.95,y:45.2},81).to({_off:true},1).wait(296));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_12).to({alpha:1},8).wait(384));
...
p.nominalBounds = new cjs.Rectangle(-21.5,0,749.5,93.9);
