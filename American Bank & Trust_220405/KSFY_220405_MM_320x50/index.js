...
// stage content:
(lib.KSFY_220405_MM_320x50 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(103).to({_off:false},0).to({y:300,alpha:1},14,cjs.Ease.get(1)).wait(63));

	// T1_png
	this.instance_2 = new lib.T1_png("synched",0);
	this.instance_2.setTransform(80,250);
	this.instance_2.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({y:300,alpha:1},14,cjs.Ease.get(1)).wait(75).to({startPosition:0},0).to({y:360,alpha:0},14).to({_off:true},1).wait(76));
	...
	// BG_png
	this.instance_4 = new lib.BG_png("synched",0);
...
p.nominalBounds = new cjs.Rectangle(159,-25,162,135);
// library properties:
lib.properties = {
