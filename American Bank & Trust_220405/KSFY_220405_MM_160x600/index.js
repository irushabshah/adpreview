...
// stage content:
(lib.KSFY_220405_MM_160x600 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// T2_png
	this.instance_1 = new lib.T2_png("synched",0);
	this.instance_1.setTransform(-80,300);
	this.instance_1.alpha = 0;
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(23).to({_off:false},0).to({x:80,alpha:1},14,cjs.Ease.get(1)).wait(203));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(14).to({_off:false},0).to({x:80,alpha:1},14,cjs.Ease.get(1)).wait(212));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).to({x:80,alpha:1},14,cjs.Ease.get(1)).wait(226));
...
p.nominalBounds = new cjs.Rectangle(-80,299,241,302);
// library properties:
lib.properties = {
