...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(144).to({_off:false},0).to({alpha:1},14,cjs.Ease.get(1)).wait(202));
	...
	this.instance_7.setTransform(80,305);
	...
	this.instance_9.setTransform(80,380);
...
p.nominalBounds = new cjs.Rectangle(149,95,152,235);
// library properties:
lib.properties = {
