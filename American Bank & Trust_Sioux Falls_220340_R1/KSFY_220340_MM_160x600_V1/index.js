...
// stage content:
(lib.KSFY_220340_MM_160x600_V1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance_4.setTransform(80,107,1,1,0,0,0,0,-193);
...
p.nominalBounds = new cjs.Rectangle(-80,299,400,302);
// library properties:
lib.properties = {
