...
// stage content:
(lib.KSFY_220340_MM_300x250_V1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(85).to({_off:false},0).to({x:80,alpha:1},14,cjs.Ease.get(1)).wait(71));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).to({x:80,alpha:1},14,cjs.Ease.get(1)).wait(57).to({startPosition:0},0).to({x:30,alpha:0},14,cjs.Ease.get(1)).wait(85));

	// Logo_png
	this.instance_4 = new lib.LOGO("synched",0);
	this.instance_4.setTransform(165,55,1,1,0,0,0,85,-245);
...
p.nominalBounds = new cjs.Rectangle(-10,124,311,127.1);
// library properties:
lib.properties = {
