...
// stage content:
(lib.KSFY_220340_MM_320x50_V1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).to({y:235,alpha:1},14,cjs.Ease.get(1)).wait(57).to({startPosition:0},0).to({y:255,alpha:0},14,cjs.Ease.get(1)).wait(85));
