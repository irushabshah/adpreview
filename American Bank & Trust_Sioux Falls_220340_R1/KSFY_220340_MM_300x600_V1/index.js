...
// stage content:
(lib.KSFY_220340_MM_300x600_V1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).to({x:80,alpha:1},14,cjs.Ease.get(1)).wait(57).to({startPosition:0},0).to({x:240,alpha:0},14,cjs.Ease.get(1)).wait(85));
...
p.nominalBounds = new cjs.Rectangle(-10,299,470,302);
// library properties:
lib.properties = {
