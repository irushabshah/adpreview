...
p.nominalBounds = new cjs.Rectangle(-150,-146,300,141);
...
p.nominalBounds = new cjs.Rectangle(-150,-148,300,141);
...
p.nominalBounds = new cjs.Rectangle(-150,-149,300,141);
...
// stage content:
(lib.WFSB_213829_MM_300x250_V5 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(21).to({graphics:mask_graphics_21,x:155.55,y:-46.225}).wait(273));
