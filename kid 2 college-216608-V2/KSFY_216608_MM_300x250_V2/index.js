...
// stage content:
(lib.KSFY_216608_MM_300x250_V2 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// F3_02
	this.instance = new lib.f3_02("synched",0);
	this.instance.setTransform(150,125,0.4,0.4,0,0,0,0.1,0.1);
	this.instance.alpha = 0;
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(239).to({_off:false},0).to({regX:0,regY:0,scaleX:1,scaleY:1,y:139,alpha:1},11,cjs.Ease.get(1)).wait(50));

	// F3_png
	this.instance_1 = new lib.Frame3("synched",0);
	this.instance_1.setTransform(80,330);
	this.instance_1.alpha = 0;
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(174).to({_off:false},0).to({y:300,alpha:1},13,cjs.Ease.get(1)).wait(52).to({startPosition:0},0).to({alpha:0},11).to({_off:true},1).wait(49));

	// F2_png
	this.instance_2 = new lib.Frame_02("synched",0);
	this.instance_2.setTransform(80,350);
	this.instance_2.alpha = 0;
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(80).to({_off:false},0).to({y:300,alpha:1},16,cjs.Ease.get(1)).wait(67).to({startPosition:0},0).to({alpha:0},11,cjs.Ease.get(1)).to({_off:true},1).wait(125));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(16).to({_off:false},0).to({y:300,alpha:1},12,cjs.Ease.get(1)).wait(272));
...
p.nominalBounds = new cjs.Rectangle(149,124,152,216);
// library properties:
lib.properties = {
	id: '9B3E3B949AEB44C1BB44682CB16F1B89',
	width: 300,
	height: 250,
	fps: 30,
	color: "#FFFFFF",
...
an.compositions['9B3E3B949AEB44C1BB44682CB16F1B89'] = {
