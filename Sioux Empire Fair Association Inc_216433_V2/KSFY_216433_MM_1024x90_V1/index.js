...
// stage content:
(lib.KSFY_216433_MM_1024x90_R1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(61).to({_off:false},0).to({y:300,alpha:1},14,cjs.Ease.get(1)).wait(68));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(47).to({_off:false},0).to({x:80,alpha:1},14,cjs.Ease.get(1)).wait(82));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(32).to({_off:false},0).to({y:300,alpha:1},14,cjs.Ease.get(1)).wait(97));
