...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-148,-308);
...
p.nominalBounds = new cjs.Rectangle(-148,-308,300,250);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-133,-369);
...
p.nominalBounds = new cjs.Rectangle(-133,-369,300,250);
...
// stage content:
(lib.WBAY_215862_MM_300x250 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({y:300},14,cjs.Ease.get(1)).wait(226));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(27).to({_off:false},0).to({y:300,alpha:1},12,cjs.Ease.get(1)).wait(201));

	// Layer_3 (mask)
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("AuTR+MADmgj7IZBAAMAAAAj7g");
	mask.setTransform(208.5,115.1);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(150).to({_off:false},0).to({y:290,alpha:1},13,cjs.Ease.get(1)).wait(77));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(88).to({_off:false},0).to({y:298.95},12,cjs.Ease.get(1)).wait(38).to({startPosition:0},0).to({alpha:0},12,cjs.Ease.get(1)).to({_off:true},1).wait(89));

	// Layer_6 (mask)
	var mask_1 = new cjs.Shape();
	mask_1._off = true;
	mask_1.graphics.p("AuTR+MADmgj7IZBAAMAAAAj7g");
	mask_1.setTransform(208.5,115.1);

	// adcopy_01_png
	this.instance_4 = new lib.adcopy_01_1("synched",0);
	this.instance_4.setTransform(150,320);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(14).to({_off:false},0).to({y:300,alpha:1},13,cjs.Ease.get(1)).wait(61).to({startPosition:0},0).to({alpha:0},12,cjs.Ease.get(1)).to({_off:true},1).wait(139));

	// _pk_jpg
	this.instance_5 = new lib._2pkSale("synched",0);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).to({y:300,alpha:1},14).wait(68).to({startPosition:0},0).to({alpha:0},12,cjs.Ease.get(1)).to({_off:true},1).wait(145));

	// Layer_9
	this.instance_6 = new lib.locationtext("synched",0);
	this.instance_6.setTransform(505.75,241);
...
p.nominalBounds = new cjs.Rectangle(-688.2,45,2537.9,225);
// library properties:
lib.properties = {
