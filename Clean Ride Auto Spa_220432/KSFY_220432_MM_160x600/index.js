...
// stage content:
(lib.KSFY_220432_MM_160x600 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(44).to({_off:false},0).to({x:80,alpha:1},14,cjs.Ease.get(1)).wait(92));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(30).to({_off:false},0).to({x:80},14,cjs.Ease.get(1)).wait(106));
...
p.nominalBounds = new cjs.Rectangle(-82.5,299,243.5,302);
// library properties:
lib.properties = {
