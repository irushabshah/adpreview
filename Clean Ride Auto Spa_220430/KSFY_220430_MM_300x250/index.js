...
// stage content:
(lib.KSFY_220430_MM_300x250 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance.setTransform(-82.5,300);
	this.instance.alpha = 0;
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(30).to({_off:false},0).to({x:80,alpha:1},14,cjs.Ease.get(1)).wait(106));

	// CTA_png
	this.instance_1 = new lib.cta("synched",0);
	this.instance_1.setTransform(378,300);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(44).to({_off:false},0).to({x:80},14,cjs.Ease.get(1)).wait(92));
...
p.nominalBounds = new cjs.Rectangle(-12.5,124,610.5,127.1);
// library properties:
lib.properties = {
