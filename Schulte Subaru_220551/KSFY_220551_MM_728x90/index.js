...
(lib.schultesubaru_white_hor = function() {
	this.initialize(img.schultesubaru_white_hor);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,7734,1600);// helper functions:
...
if (reversed == null) { reversed = false; }
	...
	// Layer_2
	this.instance = new lib.schultesubaru_white_hor();
	this.instance.setTransform(-91,-18,1.0197,1.0197);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Logo2, new cjs.Rectangle(-91,-18,181.4,37.5), null);
...
lib.properties = {
	...
	manifest: [
		...
		{src:"BG.jpg", id:"BG"},
		{src:"schultesubaru_white_hor.png", id:"schultesubaru_white_hor"}
	],
	preloads: []
};
