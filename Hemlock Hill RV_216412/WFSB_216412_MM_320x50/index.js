...
if (reversed == null) { reversed = false; }
	...
	mask._off = true;
	mask.graphics.p("ArKIbQkyAAAAkxIAAnTQAAkxEyAAIWWAAQExAAAAExIAAHTQAAExkxAAg");
	mask.setTransform(8.6,1.425);

	// Layer_1
	this.instance = new lib.newheader_Png();
	this.instance.setTransform(-178,-61,1.2,1.2);
...
}).prototype = getMCSymbolPrototype(lib.Symbol8, new cjs.Rectangle(-93.5,-52.5,204.2,107.9), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-612,-130,0.522,0.522);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Img1, new cjs.Rectangle(-612,-130,160.3,78.3), null);
...
if (reversed == null) { reversed = false; }
	...
	this.shape.graphics.f("#02216C").s().p("AgOAhQgIgDgFgFIALgMQAFAHAMAAQALAAAAgHQAAgGgHAAIgKgBQgTgCAAgQQAAgKAIgGQAHgFAKgBQARABAJAHIgKAKQgGgEgKAAQgJAAAAAGQAAAGAHABIAKAAQATACABARQAAALgJAGQgIAFgMABQgIAAgGgCg");
	this.shape.setTransform(-64.15,21.55);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#02216C").s().p("AgcAAQAAgPAHgKQAIgJANAAQAOAAAHAJQAJAKgBAOIAAAGIgpAAQAAAHAEAEQAEAEAGAAQAIAAAHgHIALALQgGAFgFACQgHAEgIAAQgfgBABgigAANgGIgCgHQgDgHgIABQgHgBgDAHIgCAHIAZAAIAAAAg");
	this.shape_1.setTransform(-70.8,21.55);
	...
	this.shape_5.setTransform(-93.525,22.725);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#02216C").s().p("AgcAAQgBgPAJgKQAHgJANAAQAOAAAIAJQAHAKAAAOIAAAGIgpAAQAAAHAEAEQAEAEAGAAQAJAAAGgHIAKALQgFAFgGACQgFAEgJAAQgegBAAgigAANgGIgCgHQgDgHgIABQgHgBgDAHIgCAHIAZAAIAAAAg");
	this.shape_6.setTransform(-103.8,21.55);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#02216C").s().p("AAFAuQgIAAgGgGQgFgFABgIIAAhIIAPAAIAABHQAAAGAGAAIAHAAIAAAOg");
	this.shape_7.setTransform(-109.2,20.3);
	...
	this.shape_8.setTransform(-115.2,21.525);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#02216C").s().p("AgOAhQgIgDgFgFIALgMQAFAHAMAAQALAAAAgHQAAgGgHAAIgKgBQgTgCAAgQQAAgKAIgGQAHgFAKgBQARABAJAHIgKAKQgGgEgKAAQgJAAAAAGQAAAGAHABIAKAAQATACABARQAAALgJAGQgIAFgMABQgIAAgGgCg");
	this.shape_9.setTransform(-121.75,21.55);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#02216C").s().p("AAOAiIgOgqIgNAqIgOAAIgUhDIASAAIALApIANgpIALAAIAOApIALgpIARAAIgUBDg");
	this.shape_10.setTransform(-132.8,21.525);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#02216C").s().p("AgUAaQgEgEgCgHQgCgFAAgKQAAgJACgGQACgGAEgFQAIgIAMAAQANAAAIAIQAFAFABAGQABAGABAJQgBAKgBAFQgBAHgFAEQgIAJgNAAQgMAAgIgJgAgGgQQgFAEAAAMQAAANAFADQADADADAAQAFAAADgDQAEgDAAgNQAAgMgEgEQgDgCgFAAQgDAAgDACg");
	this.shape_11.setTransform(-141.2,21.55);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#02216C").s().p("AAFAuQgIAAgGgGQgFgFABgIIAAhIIAPAAIAABHQAAAGAGAAIAHAAIAAAOg");
	this.shape_12.setTransform(-146.55,20.3);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#02216C").s().p("AgWAuIAAgPIADAAIAGgBQABgCABgDIADgJIgWg9IASAAIAMAqIAOgqIASAAIgdBOQgCAFgDADQgEAFgKAAg");
	this.shape_13.setTransform(-47.35,8.9);
	...
	this.shape_14.setTransform(-54.325,6.5);
	...
	this.shape_15.setTransform(-61.4,7.675);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f("#02216C").s().p("AgdAAQABgPAHgKQAJgIAMgBQAOABAHAIQAJAKAAAOIAAAGIgqAAQAAAHAEAEQAEAEAGAAQAJAAAGgGIALAKQgGAFgFADQgHADgIAAQgfAAAAgjgAANgGIgCgHQgDgGgIAAQgHAAgEAGIgBAHIAZAAIAAAAg");
	this.shape_16.setTransform(-68.2,7.7);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#02216C").s().p("AgYAiIAAhCIARAAIAAAGQAGgHAKAAQAJAAAHAGIgNANQgEgEgFAAQgDAAgDADQgEADAAAHIAAAng");
	this.shape_17.setTransform(-74.225,7.65);

	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.f("#02216C").s().p("AAFAuQgIAAgGgGQgFgFABgJIAAhHIAPAAIAABHQAAAGAGAAIAHAAIAAAOg");
	this.shape_18.setTransform(-79.5,6.45);
	...
	this.shape_21.setTransform(-101.35,7.725);

	this.shape_22 = new cjs.Shape();
	this.shape_22.graphics.f("#02216C").s().p("AgUAaQgEgEgCgHQgBgFgBgKQABgJABgGQACgGAEgFQAIgHAMgBQANABAIAHQAFAFABAGQACAGAAAJQAAAKgCAFQgBAHgFAEQgIAJgNAAQgMAAgIgJgAgGgQQgFAEAAAMQAAANAFADQADADADAAQAFAAADgDQAEgDAAgNQAAgMgEgEQgDgCgFAAQgDAAgDACg");
	this.shape_22.setTransform(-108.55,7.7);
	...
	this.shape_23.setTransform(-117.125,6.4);

	this.shape_24 = new cjs.Shape();
	this.shape_24.graphics.f("#02216C").s().p("AgUAaQgEgEgCgHQgBgFgBgKQABgJABgGQACgGAEgFQAIgHAMgBQANABAIAHQAFAFABAGQACAGAAAJQAAAKgCAFQgBAHgFAEQgIAJgNAAQgMAAgIgJgAgGgQQgFAEAAAMQAAANAFADQADADADAAQAFAAADgDQAEgDAAgNQAAgMgEgEQgDgCgFAAQgDAAgDACg");
	this.shape_24.setTransform(-122.95,7.7);
	...
	this.shape_25.setTransform(-132.875,8.875);

	this.shape_26 = new cjs.Shape();
	this.shape_26.graphics.f("#02216C").s().p("AgUAaQgEgEgCgHQgBgFAAgKQAAgJABgGQACgGAEgFQAIgHAMgBQANABAIAHQAEAFACAGQABAGABAJQgBAKgBAFQgCAHgEAEQgIAJgNAAQgMAAgIgJgAgGgQQgEAEgBAMQABANAEADQADADADAAQAFAAADgDQAEgDAAgNQAAgMgEgEQgDgCgFAAQgDAAgDACg");
	this.shape_26.setTransform(-140.2,7.7);
	...
	this.shape_27.setTransform(-146.025,6.775);

	this.shape_28 = new cjs.Shape();
	this.shape_28.graphics.f("#02216C").s().p("AALAiIAAgoQAAgGgDgDQgDgDgFAAQgEAAgDADQgDADAAAGIAAAoIgRAAIAAhCIARAAIAAAGQAGgHAJAAQAKAAAGAGQAHAGAAANIAAAqg");
	this.shape_28.setTransform(-154.85,7.65);

	this.shape_29 = new cjs.Shape();
	this.shape_29.graphics.f("#02216C").s().p("AgUAaQgEgEgCgHQgBgFgBgKQABgJABgGQACgGAEgFQAIgHAMgBQANABAIAHQAFAFABAGQACAGAAAJQAAAKgCAFQgBAHgFAEQgIAJgNAAQgMAAgIgJgAgGgQQgFAEAAAMQAAANAFADQADADADAAQAFAAADgDQAEgDAAgNQAAgMgEgEQgDgCgFAAQgDAAgDACg");
	this.shape_29.setTransform(-162.1,7.7);

	this.shape_30 = new cjs.Shape();
	this.shape_30.graphics.f("#02216C").s().p("AgiBOIAHgjIAiAAIgGAjgAgSAaIALhnIAqAAIgeBng");
	this.shape_30.setTransform(-48.575,-13.225);
	...
	this.shape_31.setTransform(-59.325,-13.225);

	this.shape_32 = new cjs.Shape();
	this.shape_32.graphics.f("#02216C").s().p("AgtBOIAZh7IglAAIAHggIBsAAIgGAgIgkAAIgYB7g");
	this.shape_32.setTransform(-69.975,-13.225);

	this.shape_33 = new cjs.Shape();
	this.shape_33.graphics.f("#02216C").s().p("AAMBOIgghQIgRBQIgkAAIAfibIAfAAIAgBQIAQhQIAlAAIgfCbg");
	this.shape_33.setTransform(-84.45,-13.225);

	this.shape_34 = new cjs.Shape();
	this.shape_34.graphics.f("#02216C").s().p("Ag0BCQgOgNAAgUIABgNIAUhiIAlAAIgVBkIgBAIQAAAQAQABQATAAAGgbIAThiIAlAAIgUBlQgGAcgTAPQgQANgWAAQgWAAgOgNg");
	this.shape_34.setTransform(-98,-13.15);
	...
	this.shape_35.setTransform(-111.925,-13.225);
	...
	this.shape_36.setTransform(-124.575,-13.225);
	...
	this.shape_37.setTransform(-137.625,-13.225);

	this.shape_38 = new cjs.Shape();
	this.shape_38.graphics.f("#02216C").s().p("AghBOIAfibIAkAAIgfCbg");
	this.shape_38.setTransform(-146.7,-13.225);
	...
	this.shape_47.setTransform(-130.325,-37.975);
...
}).prototype = getMCSymbolPrototype(lib.Head, new cjs.Rectangle(-173.7,-53.9,137.79999999999998,82.8), null);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(41).to({_off:false},0).to({regX:220.5,regY:33.6,scaleX:0.1873,scaleY:0.1873},10,cjs.Ease.get(1)).wait(189));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(41).to({_off:false},0).to({regX:220.6,regY:33.6,scaleX:0.275,scaleY:0.275,x:8.25},10,cjs.Ease.get(1)).wait(189));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(36).to({_off:false},0).to({regX:220.7,regY:33.6,scaleX:0.3109,scaleY:0.3109,x:66.9},10,cjs.Ease.get(1)).wait(194));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(27).to({_off:false},0).to({regY:0.1,y:43.5,alpha:1},9,cjs.Ease.get(1)).wait(204));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(18).to({_off:false},0).to({regY:0.1,y:40.4,alpha:1},9,cjs.Ease.get(1)).wait(213));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(18).to({_off:false},0).to({regX:0.2,x:575.65,alpha:1},9,cjs.Ease.get(1)).wait(213));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(9).to({_off:false},0).to({regY:0.6,y:32.6,alpha:1},9,cjs.Ease.get(1)).wait(222));

	// RRLogo
	this.instance_7 = new lib.Symbol8();
	this.instance_7.setTransform(34.5,25.05,0.1341,0.1341,0,0,0,1.5,1.9);
	this.instance_7.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).to({regX:0.8,regY:1,scaleX:0.3144,scaleY:0.3144,alpha:1},9,cjs.Ease.get(1)).wait(231));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_9},{t:this.instance_8}]}).wait(240));

	// Layer_2
	this.instance_10 = new lib.Bg600();
	this.instance_10.setTransform(-4,-288,0.4096,0.4096);
...
p.nominalBounds = new cjs.Rectangle(-21.7,-288,345.4,393.6);


// stage content:
(lib.WFSB_216412_MM_320x50 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
