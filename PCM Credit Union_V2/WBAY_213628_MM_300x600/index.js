...
if (reversed == null) { reversed = false; }
	...
	this.shape_1.setTransform(-43.8966,100.6902,1.5838,1.5838);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#144154").s().p("AAAFNIgEqZIAEAAIAFKZg");
	this.shape_2.setTransform(-44.3682,113.559,1.5838,1.5838);
	...
	this.shape_4.setTransform(-42.9427,109.6786,1.5838,1.5838);
	...
	this.shape_19.setTransform(191.3826,81.4658,1.5838,1.5838);
...
}).prototype = getMCSymbolPrototype(lib.pic1, new cjs.Rectangle(-58.9,-16.9,326.5,215.5), null);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(189).to({_off:false},0).to({regX:0.1,regY:0.1,scaleX:0.972,scaleY:0.972,x:446.95,startPosition:167},69).wait(2));
	...
	this.instance_11.setTransform(430.3,369.1,0.6234,0.6234,0,0,0,115.7,110.2);
