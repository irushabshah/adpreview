...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({regX:0,regY:0,rotation:29.9992,x:0,y:517.7},143,cjs.Ease.get(1)).wait(1));
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-0.05,-362.65,1,1,-59.9984,0,0,0.1,-0.1);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(90.95,-62.05,0.8,0.8);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(24).to({_off:false},0).wait(60).to({startPosition:60},0).to({alpha:0,startPosition:82},22).wait(39));

	// Brown
	this.instance_1 = new lib.fall_yellowcopy("synched",0);
	this.instance_1.setTransform(90.95,-62.05,0.8,0.8);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(24).to({_off:false},0).wait(121));

	// Yellow
	this.instance_2 = new lib.fall_yellow("synched",0);
	this.instance_2.setTransform(0.95,-62.05,0.8,0.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(46).to({startPosition:46},0).to({alpha:0,startPosition:65},19).wait(80));

	// Brown
	this.instance_3 = new lib.fall_yellowcopy("synched",0);
	this.instance_3.setTransform(0.95,-62.05,0.8,0.8);
...
p.nominalBounds = new cjs.Rectangle(-78,-427.1,248,856.5);


// stage content:
(lib.WBAY_218322_MM_160x600 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(156).to({_off:false},0).to({y:300,alpha:1},14,cjs.Ease.get(1)).wait(190));

	// F4_T1_png
	this.instance_1 = new lib.F4_T1_1("synched",0);
	this.instance_1.setTransform(80,330);
	this.instance_1.alpha = 0;
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(285).to({_off:false},0).to({y:300,alpha:1},14,cjs.Ease.get(1)).wait(61));

	// F3_T1_png
	this.instance_2 = new lib.F3_T1_1("synched",0);
	this.instance_2.setTransform(80,330);
	this.instance_2.alpha = 0;
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(224).to({_off:false},0).to({y:300,alpha:1},14,cjs.Ease.get(1)).wait(31).to({startPosition:0},0).to({y:330,alpha:0},14).to({_off:true},1).wait(76));

	// F2_T2_png
	this.instance_3 = new lib.F2_T2_1("synched",0);
	this.instance_3.setTransform(80,350);
	this.instance_3.alpha = 0;
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(161).to({_off:false},0).to({y:300,alpha:1},14,cjs.Ease.get(1)).wait(33).to({startPosition:0},0).to({y:350,alpha:0},14).to({_off:true},1).wait(137));

	// F2_T1_png
	this.instance_4 = new lib.F2_T1_1("synched",0);
	this.instance_4.setTransform(80,230);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(156).to({_off:false},0).to({scaleX:1,alpha:1},9,cjs.Ease.get(1)).wait(195));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(32).to({_off:false},0).to({y:300,alpha:1},12,cjs.Ease.get(1)).wait(99).to({startPosition:0},0).to({alpha:0},12).to({_off:true},1).wait(204));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(22).to({_off:false},0).to({y:300,alpha:1},14,cjs.Ease.get(1)).wait(107).to({startPosition:0},0).to({alpha:0},12).to({_off:true},1).wait(204));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(11).to({_off:false},0).to({y:300,alpha:1},14,cjs.Ease.get(1)).wait(118).to({startPosition:0},0).to({alpha:0},12).to({_off:true},1).wait(204));

	// Logo_png
	this.instance_9 = new lib.Logo_1("synched",0);
	this.instance_9.setTransform(80,220);

	this.timeline.addTween(cjs.Tween.get(this.instance_9).to({y:300},14,cjs.Ease.get(1)).wait(346));

	// Layer_7
	this.instance_10 = new lib.FALLANIMATION("synched",0);
	this.instance_10.setTransform(27.55,310.15);

	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(360));

	// BG_png
	this.instance_11 = new lib.BG_1("synched",0);
...
p.nominalBounds = new cjs.Rectangle(29.5,172.9,168,566.7);
// library properties:
lib.properties = {
