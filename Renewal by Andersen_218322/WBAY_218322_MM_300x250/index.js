...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({regX:0,regY:0,rotation:29.9992,x:0,y:63.85},143,cjs.Ease.get(1)).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-98.7,-456.3,197.5,616.9);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(46).to({startPosition:46},0).to({alpha:0,startPosition:65},19).wait(79));
...
p.nominalBounds = new cjs.Rectangle(-78,-427.1,158.1,493.6);


// stage content:
(lib.WBAY_218322_MM_300x250 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(144).to({_off:false},0).to({scaleX:1,alpha:1},9,cjs.Ease.get(1)).wait(207));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(32).to({_off:false},0).to({y:300,alpha:1},12,cjs.Ease.get(1)).wait(87).to({startPosition:0},0).to({alpha:0},12).to({_off:true},1).wait(216));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(22).to({_off:false},0).to({y:300,alpha:1},14,cjs.Ease.get(1)).wait(95).to({startPosition:0},0).to({alpha:0},12).to({_off:true},1).wait(216));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(11).to({_off:false},0).to({y:300,alpha:1},14,cjs.Ease.get(1)).wait(106).to({startPosition:0},0).to({alpha:0},12).to({_off:true},1).wait(216));
	...
	this.instance_10.setTransform(249.05,311.1);
	this.instance_10._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(31).to({_off:false},0).to({_off:true},286).wait(43));

	// Layer_3
	this.instance_11 = new lib.FALLANIMATION("synched",0);
	this.instance_11.setTransform(79.05,307.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(352).to({startPosition:64},0).to({alpha:0,startPosition:71},7).wait(1));
...
p.nominalBounds = new cjs.Rectangle(149,5,180,372.5);
// library properties:
lib.properties = {
