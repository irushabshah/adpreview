    ...
    if os.path.isdir(advertiser) and not advertiser.startswith('.'):
        ...
        for item in sorted(os.listdir(advertiser)):
            ...
            # CASE 2: Static Image File (JPG, PNG, GIF)
                ...
                if item == "index.html": continue # Don't treat the master preview as an ad
        ...
        # Save the master index.html inside the Advertiser folder (as per PDF logic)
        if client_content:
