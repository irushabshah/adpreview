...
// stage content:
(lib.KSFY_216645_MM_R1_160x600 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(31).to({_off:false},0).to({y:300},14,cjs.Ease.get(1)).wait(65).to({startPosition:0},0).to({y:339.15},11,cjs.Ease.get(1)).wait(101));

	// F2_T2_png
	this.instance_1 = new lib.F2_T2_png("synched",0);
	this.instance_1.setTransform(80.05,410.25,0.8,0.8,0,0,0,0.1,110.3);
	this.instance_1.alpha = 0;
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(135).to({_off:false},0).to({regX:0,regY:110.2,scaleX:1,scaleY:1,x:80,y:410.2,alpha:1},12,cjs.Ease.get(1)).wait(75));

	// F2_T1_png
	this.instance_2 = new lib.F2_T1_png("synched",0);
	this.instance_2.setTransform(79.95,299.95,0.9,0.9);
	this.instance_2.alpha = 0;
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(122).to({_off:false},0).to({scaleX:1,scaleY:1,x:80,y:300,alpha:1},11,cjs.Ease.get(1)).wait(89));
	...
	this.instance_4.setTransform(80,300,1,0.1525);
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(110).to({_off:false},0).to({scaleY:1},11,cjs.Ease.get(1)).wait(101));
	...
	this.instance_6.setTransform(80.05,78.1,0.81,0.81,0,0,0,0.1,-221.8);
	this.instance_6.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).to({regX:0,scaleX:1,scaleY:1,x:80,y:78.2,alpha:1},14,cjs.Ease.get(1)).wait(208));
...
p.nominalBounds = new cjs.Rectangle(79,274,82,430);
// library properties:
lib.properties = {
