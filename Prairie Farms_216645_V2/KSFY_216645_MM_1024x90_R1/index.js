...
p.nominalBounds = new cjs.Rectangle(0,0,664,90);


(lib.F2_IMAGE = function() {
	this.initialize(img.F2_IMAGE);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,1024,204);
...
p.nominalBounds = new cjs.Rectangle(-80,-300,1024,204);
...
p.nominalBounds = new cjs.Rectangle(-80,-300,664,90);
...
// stage content:
(lib.KSFY_216645_MM_R1_1024x90 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(32).to({_off:false},0).to({y:300},14,cjs.Ease.get(1)).wait(54).to({startPosition:0},0).to({y:289},9,cjs.Ease.get(1)).wait(114));

	// F2_T2_png
	this.instance_1 = new lib.F2_T2_png("synched",0);
	this.instance_1.setTransform(675.3,41.75,0.81,0.81,0,0,0,595.4,-254.2);
	this.instance_1.alpha = 0;
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(136).to({_off:false},0).to({regX:595.3,scaleX:1,scaleY:1,y:41.8,alpha:1},12,cjs.Ease.get(1)).wait(75));

	// F2_T1_png
	this.instance_2 = new lib.F2_T1_png("synched",0);
	this.instance_2.setTransform(216.05,49.75,0.9,0.9,0,0,0,136.1,-250.2);
	this.instance_2.alpha = 0;
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(123).to({_off:false},0).to({regX:136,scaleX:1,scaleY:1,x:216,y:49.8,alpha:1},11,cjs.Ease.get(1)).wait(89));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(123).to({_off:false},0).to({alpha:1},11,cjs.Ease.get(1)).wait(89));

	// F2_BG_png
	this.instance_4 = new lib.F2_BG_png("synched",0);
	this.instance_4.setTransform(509,45,0.0967,1,0,0,0,283.9,-255);
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(111).to({_off:false},0).to({regX:284,scaleX:1},11,cjs.Ease.get(1)).wait(101));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(16).to({_off:false},0).to({y:300,alpha:1},14,cjs.Ease.get(1)).wait(70).to({startPosition:0},0).to({alpha:0},9).to({_off:true},1).wait(113));

	// LOGO_png
	this.instance_6 = new lib.LOGO_png("synched",0);
	this.instance_6.setTransform(78.15,41.65,0.8,0.8,0,0,0,-1.8,-258.3);
	this.instance_6.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).to({regX:-1.9,regY:-258.4,scaleX:1,scaleY:1,x:78.1,y:41.6,alpha:1},14,cjs.Ease.get(1)).wait(209));

	// F1_IMAGE_png
	this.instance_7 = new lib.F1_IMAGE_png("synched",0);
	this.instance_7.setTransform(80,300);

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(100).to({startPosition:0},0).to({alpha:0},9).to({_off:true},1).wait(113));
...
p.nominalBounds = new cjs.Rectangle(511,19,514,185);
// library properties:
lib.properties = {
