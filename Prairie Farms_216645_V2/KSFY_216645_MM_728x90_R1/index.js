...
// stage content:
(lib.KSFY_216645_MM_R1_728x90 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(31).to({_off:false},0).to({y:300},14,cjs.Ease.get(1)).wait(65).to({startPosition:0},0).to({y:285},11,cjs.Ease.get(1)).wait(101));

	// F2_T2_png
	this.instance_1 = new lib.F2_T2_png("synched",0);
	this.instance_1.setTransform(470.25,45.75,0.9,0.9,0,0,0,390.3,-254.2);
	this.instance_1.alpha = 0;
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(135).to({_off:false},0).to({regX:390.2,scaleX:1,scaleY:1,x:470.2,y:45.8,alpha:1},11,cjs.Ease.get(1)).wait(76));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(122).to({_off:false},0).to({regX:136,scaleX:1,scaleY:1,x:216,y:49.8,alpha:1},11,cjs.Ease.get(1)).wait(89));
	...
	this.instance_4.setTransform(364,45,0.1317,1,0,0,0,283.9,-255);
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(110).to({_off:false},0).to({regX:284,scaleX:1},11,cjs.Ease.get(1)).wait(101));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).to({regX:-1.9,regY:-258.4,scaleX:1,scaleY:1,x:78.1,y:41.6,alpha:1},14,cjs.Ease.get(1)).wait(208));
...
p.nominalBounds = new cjs.Rectangle(363,19,366,175);
// library properties:
lib.properties = {
