...
p.nominalBounds = new cjs.Rectangle(-80,-300,300,356);
...
// stage content:
(lib.KSFY_216645_MM_R1_300x600 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(31).to({_off:false},0).to({y:300},14,cjs.Ease.get(1)).wait(65).to({startPosition:0},0).to({y:313.5},11,cjs.Ease.get(1)).wait(101));

	// F2_T2_png
	this.instance_1 = new lib.F2_T2_png("synched",0);
	this.instance_1.setTransform(160.15,427.95,0.8,0.8,0,0,0,80.2,121);
	this.instance_1.alpha = 0;
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(135).to({_off:false},0).to({regY:120.9,scaleX:1,scaleY:1,x:160.2,y:427.9,alpha:1},11,cjs.Ease.get(1)).wait(76));

	// F2_T1_png
	this.instance_2 = new lib.F2_T1_png("synched",0);
	this.instance_2.setTransform(159.95,191.75,0.8,0.8,0,0,0,80,-115.2);
	this.instance_2.alpha = 0;
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(122).to({_off:false},0).to({scaleX:1,scaleY:1,x:160,y:191.8,alpha:1},11,cjs.Ease.get(1)).wait(89));

	// F2_IMAGE_png
	this.instance_3 = new lib.F2_IMAGE_png("synched",0);
	this.instance_3.setTransform(80,307);
	...
	this.instance_4.setTransform(150,314.95,1,0.136,0,0,0,70,-122.1);
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(110).to({_off:false},0).to({regY:-122,scaleY:1,y:315},11).wait(101));
	...
	this.instance_6.setTransform(161.15,86.65,0.8,0.8,0,0,0,81.2,-213.3);
	this.instance_6.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).to({scaleX:1,scaleY:1,x:161.2,y:86.7,alpha:1},15,cjs.Ease.get(1)).wait(207));
...
p.nominalBounds = new cjs.Rectangle(149,274,152,430);
// library properties:
lib.properties = {
