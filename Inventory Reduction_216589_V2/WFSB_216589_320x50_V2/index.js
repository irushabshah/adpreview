...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(19).to({_off:false},0).to({x:80,y:300},14,cjs.Ease.get(1)).wait(214));

	// Logo.png
	this.instance_1 = new lib.Logo_1("synched",0);
	this.instance_1.setTransform(79.35,230);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(13).to({_off:false},0).to({x:80,y:300},14,cjs.Ease.get(1)).wait(220));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(131).to({_off:false},0).to({y:300,alpha:1},14,cjs.Ease.get(1)).wait(102));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(73).to({_off:false},0).to({y:300,alpha:1},14,cjs.Ease.get(1)).wait(31).to({startPosition:0},0).to({alpha:0},12).to({_off:true},1).wait(116));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(6).to({_off:false},0).to({alpha:1},14,cjs.Ease.get(1)).wait(39).to({startPosition:0},0).to({alpha:0},12).to({_off:true},1).wait(175));

	// InventoryReduction.png
	this.instance_5 = new lib.InventoryReduction_1("synched",0);
	this.instance_5.setTransform(80,220);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).to({y:300},14,cjs.Ease.get(1)).wait(233));

	// BG.jpg
	this.instance_6 = new lib.bg("synched",0);
	this.instance_6.setTransform(80,300);

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(247));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-0.6,-80,320.6,180);


// stage content:
(lib.WFSB_216589_320x50_V2 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
