...
if (reversed == null) { reversed = false; }
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).wait(201).call(this.frame_201).wait(240));
	...
	this.timeline.addTween(cjs.Tween.get(this.ad_clickBtn).to({_off:true},202).wait(239));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(39).to({_off:false},0).to({y:300},14,cjs.Ease.get(1)).wait(388));

	// CTA.png
	this.instance_1 = new lib.CTA_1("synched",0);
	this.instance_1.setTransform(-83.35,300);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(34).to({_off:false},0).to({x:80},14,cjs.Ease.get(1)).to({_off:true},192).wait(201));

	// Logo.png
	this.instance_2 = new lib.Logo_1("synched",0);
	this.instance_2.setTransform(-80.65,300);
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(29).to({_off:false},0).to({x:80},14,cjs.Ease.get(1)).to({_off:true},197).wait(201));

	// T4.png
	this.instance_3 = new lib.T4_1("synched",0);
	this.instance_3.setTransform(80,317);
	this.instance_3.alpha = 0;
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(23).to({_off:false},0).to({y:300,alpha:1},14,cjs.Ease.get(1)).to({_off:true},203).wait(201));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(18).to({_off:false},0).to({y:300,alpha:1},14,cjs.Ease.get(1)).to({_off:true},208).wait(201));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(13).to({_off:false},0).to({y:300,alpha:1},14,cjs.Ease.get(1)).to({_off:true},213).wait(201));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(6).to({_off:false},0).to({y:300,alpha:1},14,cjs.Ease.get(1)).to({_off:true},220).wait(201));

	// InventoryReduction.png
	this.instance_7 = new lib.InventoryReduction_1("synched",0);
	this.instance_7.setTransform(80,166);

	this.timeline.addTween(cjs.Tween.get(this.instance_7).to({y:300},14,cjs.Ease.get(1)).to({_off:true},226).wait(201));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(36).to({_off:false},0).to({alpha:1},12,cjs.Ease.get(1)).to({_off:true},192).wait(201));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(30).to({_off:false},0).to({startPosition:0},14,cjs.Ease.get(1)).to({_off:true},196).wait(201));

	// BG.jpg
	this.instance_10 = new lib.bg("synched",0);
	this.instance_10.setTransform(80,300);

	this.timeline.addTween(cjs.Tween.get(this.instance_10).to({_off:true},240).wait(201));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-163.3,-134,463.3,788);


// stage content:
(lib.WFSB_216589_300x600_V2 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
