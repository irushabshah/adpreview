...
// stage content:
(lib.WBAY_215861_MM_160x600 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(27).to({_off:false},0).to({y:300,alpha:1},12,cjs.Ease.get(1)).wait(33).to({y:301},0).to({y:353},15).wait(135));

	// Layer_4 (mask)
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("A4OMqIAA5TMAwdAAAIAAZTg");
	mask.setTransform(155.05,445.15);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(150).to({_off:false},0).to({alpha:1},13,cjs.Ease.get(1)).wait(59));

	// sale_01_jpg
	this.instance_3 = new lib.S1("synched",0);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(88).to({_off:false},0).to({alpha:1},13,cjs.Ease.get(1)).to({_off:true},50).wait(71));

	// Layer_7 (mask)
	var mask_1 = new cjs.Shape();
	mask_1._off = true;
	mask_1.graphics.p("A3bLaIAA2zMAu3AAAIAAWzg");
	mask_1.setTransform(150,284.1);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).to({y:300,alpha:1},14).wait(208));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(14).to({_off:false},0).to({y:300,alpha:1},13,cjs.Ease.get(1)).wait(48).to({startPosition:0},0).to({alpha:0},12,cjs.Ease.get(1)).to({_off:true},1).wait(134));
...
p.nominalBounds = new cjs.Rectangle(-775.2,220,2607.9,433);
// library properties:
lib.properties = {
