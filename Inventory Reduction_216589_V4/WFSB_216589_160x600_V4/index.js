...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(34).to({_off:false},0).to({x:80},14,cjs.Ease.get(1)).wait(192));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(13).to({_off:false},0).to({startPosition:0},14,cjs.Ease.get(1)).wait(78).to({startPosition:0},0).to({alpha:0},12).to({_off:true},1).wait(122));
...
// stage content:
(lib.WFSB_216589_160x600_V4 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
