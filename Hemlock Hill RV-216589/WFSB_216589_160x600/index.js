...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(133.05,348.7,0.0736,0.0736,0,0,0,220.7,34.6);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(58).to({_off:false},0).to({regX:220.8,regY:33.8,scaleX:0.2086,scaleY:0.2086,x:133.1},10,cjs.Ease.get(1)).wait(172));

	// glitter 1 copy 5
	this.instance_1 = new lib.Sparkle_1();
	this.instance_1.setTransform(142.95,394.9,0.1473,0.1473,0,0,0,220.7,33.6);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(53).to({_off:false},0).to({regY:33.7,scaleX:0.4171,scaleY:0.4171,x:143},10,cjs.Ease.get(1)).wait(177));

	// glitter 1 copy 2
	this.instance_2 = new lib.Sparkle_1();
	this.instance_2.setTransform(37.65,16.9,0.1357,0.1357,0,0,0,220.8,33.9);
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(42).to({_off:false},0).to({regX:220.6,regY:33.7,scaleX:0.3843,scaleY:0.3843,x:37.7},10,cjs.Ease.get(1)).wait(188));

	// glitter 1 copy 3
	this.instance_3 = new lib.Sparkle_1();
	this.instance_3.setTransform(19.05,36.95,0.2714,0.2714,0,0,0,220.3,33.7);
	...
	this.instance_5.setTransform(146.95,50.3,0.166,0.166,0,0,0,220.4,33.8);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(28).to({_off:false},0).to({y:572.15,alpha:1},9,cjs.Ease.get(1)).wait(203));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(19).to({_off:false},0).to({y:567.7,alpha:1},9,cjs.Ease.get(1)).wait(212));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(18).to({_off:false},0).to({alpha:1},9).wait(213));
	...
	this.instance_12.setTransform(80,88,0.72,0.72,0,0,0,0.1,-211.9);
	this.instance_12.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_12).to({regX:0,regY:-212,scaleX:1,scaleY:1,alpha:1},9,cjs.Ease.get(1)).wait(231));

	// Corner
	this.instance_13 = new lib.Corner();
	this.instance_13.setTransform(141.1,601.15,0.7105,0.7105,180);

	this.instance_14 = new lib.Corner();
	this.instance_14.setTransform(20,-1,0.7105,0.7105);
	...
	this.timeline.addTween(cjs.Tween.get(this.shape).wait(9).to({_off:false},0).wait(1).to({x:80.4,y:651.175},0).wait(1).to({y:623.725},0).wait(1).to({y:599.925},0).wait(1).to({y:579.825},0).wait(1).to({y:563.325},0).wait(1).to({y:550.525},0).wait(1).to({y:541.375},0).wait(1).to({y:535.925},0).wait(1).to({x:80.4012,y:534.0832},0).wait(222));
...
// stage content:
(lib.WFSB_216589_160x600 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
