...
if (reversed == null) { reversed = false; }
	...
	this.instance_1.setTransform(34,25,0.1862,0.1862,0,0,0,220.5,33.9);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(51).to({_off:false},0).to({regX:220.7,regY:33.6,scaleX:0.5274,scaleY:0.5274,x:34.1,y:24.95},10,cjs.Ease.get(1)).wait(101));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(46).to({_off:false},0).to({regX:220.6,regY:33.6,scaleX:1.0548,scaleY:1.0548,x:17.15},10,cjs.Ease.get(1)).wait(106));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(46).to({_off:false},0).to({regX:220.6,regY:33.6,scaleX:1.0548,scaleY:1.0548,x:282.65},10,cjs.Ease.get(1)).wait(106));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(18).to({_off:false},0).to({alpha:1},9).wait(135));

	// DATE.png
	this.instance_8 = new lib.DATE_1();
	this.instance_8.setTransform(80,300);
	this.instance_8.alpha = 0;
	this.instance_8._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(20).to({_off:false},0).to({alpha:1},9).wait(133));

	// 46.png
	this.instance_9 = new lib._46_1();
	this.instance_9.setTransform(80,293);
	this.instance_9.alpha = 0;
	this.instance_9._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(9).to({_off:false},0).to({y:300,alpha:1},9,cjs.Ease.get(1)).wait(144));

	// $150.png
	this.instance_10 = new lib._150_1();
	this.instance_10.setTransform(80,293);
	this.instance_10.alpha = 0;
	this.instance_10._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(9).to({_off:false},0).to({y:300,alpha:1},9,cjs.Ease.get(1)).wait(144));

	// InventoryReduction.png
	this.instance_11 = new lib.InventoryReduction_1();
	this.instance_11.setTransform(155,43,0.6,0.6,0,0,0,75.1,-256.9);
	this.instance_11.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_11).to({regX:75,regY:-257,scaleX:1,scaleY:1,alpha:1},9,cjs.Ease.get(1)).wait(153));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_13},{t:this.instance_12}]}).wait(162));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(162));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-23.5,-7,344.7,326.1);


// stage content:
(lib.WFSB_216589_300x250 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
