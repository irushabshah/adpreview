...
}).prototype = getMCSymbolPrototype(lib.img1, new cjs.Rectangle(-80,-300,320,50), null);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(98).to({_off:false},0).to({alpha:1},9).wait(133));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(89).to({_off:false},0).to({y:300,alpha:1},9,cjs.Ease.get(1)).wait(142));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(9).to({_off:false},0).to({y:300,alpha:1},9,cjs.Ease.get(1)).wait(62).to({y:350,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(151));

	// InventoryReduction.png
	this.instance_9 = new lib.InventoryReduction_1();
	this.instance_9.setTransform(55,23,0.6,0.6,0,0,0,-24.9,-276.9);
	this.instance_9.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_9).to({regX:-25,regY:-277,scaleX:1,scaleY:1,alpha:1},9,cjs.Ease.get(1)).wait(231));

	// Corner
	this.instance_10 = new lib.Corner();
	this.instance_10.setTransform(71,54.95,0.3601,0.3601,180);

	this.instance_11 = new lib.Corner();
	this.instance_11.setTransform(249,-3,0.3601,0.3601);
	...
	this.shape_1.setTransform(357.125,24.75);
	this.shape_1._off = true;

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape,p:{x:379.159}}]},9).to({state:[{t:this.shape_1}]},1).to({state:[{t:this.shape_1}]},1).to({state:[{t:this.shape_1}]},1).to({state:[{t:this.shape_1}]},1).to({state:[{t:this.shape_1}]},1).to({state:[{t:this.shape_1}]},1).to({state:[{t:this.shape_1}]},1).to({state:[{t:this.shape_1}]},1).to({state:[{t:this.shape,p:{x:274.159}}]},1).wait(222));
	this.timeline.addTween(cjs.Tween.get(this.shape_1).wait(10).to({_off:false},0).wait(1).to({x:337.675},0).wait(1).to({x:320.825},0).wait(1).to({x:306.575},0).wait(1).to({x:294.925},0).wait(1).to({x:285.825},0).wait(1).to({x:279.375},0).wait(1).to({x:275.475},0).to({_off:true},1).wait(222));
