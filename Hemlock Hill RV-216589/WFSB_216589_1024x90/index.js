...
if (reversed == null) { reversed = false; }
	...
	this.instance_4.setTransform(851.45,45.85);
	this.instance_4.alpha = 0;
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(36).to({_off:false},0).to({alpha:1},9,cjs.Ease.get(1)).wait(195));
	...
	this.instance_7.setTransform(80,304);
	this.instance_7.alpha = 0;
	this.instance_7._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(18).to({_off:false},0).to({alpha:1},9).wait(213));
	...
	this.instance_9.setTransform(80,280);
	this.instance_9.alpha = 0;
	this.instance_9._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(9).to({_off:false},0).to({y:300,alpha:1},9,cjs.Ease.get(1)).wait(222));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_11).to({regX:2,regY:-256,scaleX:1,scaleY:1,alpha:1},9,cjs.Ease.get(1)).wait(231));
...
p.nominalBounds = new cjs.Rectangle(-1,-30,1461.2,161.4);


// stage content:
(lib.WFSB_216589_1024x90 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
