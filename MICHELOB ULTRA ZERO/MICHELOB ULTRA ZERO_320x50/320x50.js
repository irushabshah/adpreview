...
}).prototype = getMCSymbolPrototype(lib.text4_1, new cjs.Rectangle(-80,-300,320,50), null);
...
}).prototype = getMCSymbolPrototype(lib.text3_1, new cjs.Rectangle(-80,-300,320,50), null);
...
}).prototype = getMCSymbolPrototype(lib.text2_1, new cjs.Rectangle(-80,-300,320,50), null);
...
}).prototype = getMCSymbolPrototype(lib.text1_1, new cjs.Rectangle(-80,-300,320,50), null);
...
}).prototype = getMCSymbolPrototype(lib.NEW, new cjs.Rectangle(0,0,320,50), null);
...
}).prototype = getMCSymbolPrototype(lib.logo_1, new cjs.Rectangle(-80,-300,320,50), null);
...
}).prototype = getMCSymbolPrototype(lib.image2_1, new cjs.Rectangle(-80,-300,320,50), null);
...
}).prototype = getMCSymbolPrototype(lib.image1_1, new cjs.Rectangle(-80,-300,320,50), null);
...
}).prototype = getMCSymbolPrototype(lib.cta_1, new cjs.Rectangle(-80,-300,320,50), null);
...
}).prototype = getMCSymbolPrototype(lib.bg3, new cjs.Rectangle(0,0,320,50), null);
...
}).prototype = getMCSymbolPrototype(lib.bg2, new cjs.Rectangle(0,0,320,50), null);
...
if (reversed == null) { reversed = false; }
	...
	// image3
	this.instance_9 = new lib.image3_1();
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(344).to({_off:false},0).wait(46));

	// text2_png
	this.instance_11 = new lib.text3_1();
	this.instance_11.setTransform(80,350);
	this.instance_11.alpha = 0;
	this.instance_11._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(204).to({_off:false},0).to({y:300,alpha:1},10,cjs.Ease.get(1)).to({_off:true},140).wait(36));

	// Layer_18
	this.instance_12 = new lib.shape4();
	this.instance_12.setTransform(852,300);
	this.instance_12._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(179).to({_off:false},0).to({x:-456},25,cjs.Ease.get(1)).wait(186));

	// Layer_17
	this.instance_13 = new lib.shape3();
	this.instance_13.setTransform(453.45,116.5,0.6837,0.6825,0,0,0,0.1,0.1);
	this.instance_13._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(179).to({_off:false},0).to({x:-774.55},25,cjs.Ease.get(1)).wait(186));

	// Layer_16
	this.instance_14 = new lib.shape2();
	this.instance_14.setTransform(472,442.5);
	this.instance_14._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(179).to({_off:false},0).to({x:-756},25,cjs.Ease.get(1)).wait(186));

	// Layer_14
	this.instance_15 = new lib.shape1();
	this.instance_15.setTransform(287,322.5);
	this.instance_15._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_15).wait(179).to({_off:false},0).to({x:-941},25,cjs.Ease.get(1)).wait(186));

	// Layer_15
	this.instance_16 = new lib.shape1();
	this.instance_16.setTransform(377,390.05,1.3743,1.3743);
	this.instance_16.alpha = 0.1211;
	this.instance_16._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_16).wait(179).to({_off:false},0).to({x:-851},25,cjs.Ease.get(1)).wait(186));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_17).wait(194).to({_off:false},0).to({alpha:1},10,cjs.Ease.get(1)).wait(186));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_18).wait(194).to({_off:false},0).wait(196));

	// text2
	this.instance_19 = new lib.text2_1();
	this.instance_19.setTransform(80,280);
	this.instance_19.alpha = 0;
	this.instance_19._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_19).wait(56).to({_off:false},0).to({y:300,alpha:1},14).to({_off:true},134).wait(186));

	// text1_png
	this.instance_20 = new lib.text1_1();
	this.instance_20.setTransform(80,280);
	this.instance_20.alpha = 0;
	this.instance_20._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_20).wait(28).to({_off:false},0).to({y:300,alpha:1},14).to({_off:true},162).wait(186));

	// image1_png
	this.instance_21 = new lib.image1_1();
	this.instance_21.setTransform(60,327.5,1.1,1.1);
	this.instance_21.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_21).to({scaleX:1,scaleY:1,x:80,y:300,alpha:1},14).to({_off:true},190).wait(186));

	// BG
	this.instance_22 = new lib.BG_1();
	this.instance_22.setTransform(80,300,1,1,0,0,0,80,300);

	this.timeline.addTween(cjs.Tween.get(this.instance_22).to({_off:true},204).wait(186));

	this._renderFirstFrame();

}).prototype = p = new lib.AnMovieClip();
p.nominalBounds = new cjs.Rectangle(-764.7,-41.9,1913.7,575);
// library properties:
lib.properties = {
