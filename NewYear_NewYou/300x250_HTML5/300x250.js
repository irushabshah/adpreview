...
}).prototype = getMCSymbolPrototype(lib.snow_1, new cjs.Rectangle(0,0,300,250), null);
...
}).prototype = getMCSymbolPrototype(lib.image7_1, new cjs.Rectangle(0,0,300,250), null);
...
}).prototype = getMCSymbolPrototype(lib.image6_1, new cjs.Rectangle(0,0,300,250), null);
...
}).prototype = getMCSymbolPrototype(lib.image5_1, new cjs.Rectangle(0,0,300,250), null);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({alpha:1},9,cjs.Ease.get(1)).wait(110).to({x:160},12,cjs.Ease.get(1)).wait(139));
	...
	this.instance_4.setTransform(340.05,42.45,0.2,0.2,-144.503,0,0,84.5,467.7);
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(49).to({_off:false},0).to({scaleX:1,scaleY:1,rotation:-137.043,x:299.95,y:-0.05},10).to({scaleX:0.2,scaleY:0.2,rotation:-144.503,x:340.05,y:42.45},10).wait(201));
	...
	// image6_png
	this.instance_7 = new lib.image6_1();
	...
	// image7
	this.instance_8 = new lib.image7_1();
...
p.nominalBounds = new cjs.Rectangle(76,-23.3,384,423.2);
// library properties:
lib.properties = {
	id: 'C1A4C5A8727A4B97AEDD8B9B0980DA9D',
	width: 300,
	height: 250,
	fps: 30,
	color: "#FFFFFF",
...
an.compositions['C1A4C5A8727A4B97AEDD8B9B0980DA9D'] = {
