...
p.nominalBounds = new cjs.Rectangle(0,0,187,241);// helper functions:
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-69,-17,1.0511,1.0511);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Logo2_1, new cjs.Rectangle(-69,-17,61,78.6), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-96,-36,0.12,0.12);
...
p.nominalBounds = new cjs.Rectangle(-96,-36,171.1,40.5);
...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(24.15,0.325);
	...
	this.shape_3.setTransform(-3.5,0.325);
	...
	this.shape_6.setTransform(-26.55,0.3);
...
}).prototype = getMCSymbolPrototype(lib.BG_1, new cjs.Rectangle(-150,-125,160,600), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(80.2,572.8,0.3434,0.3434,0,0,0,0.1,0.3);
	this.instance.alpha = 0;
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(33).to({_off:false},0).to({regY:0.1,scaleX:1.2018,scaleY:1.2018,x:80.25,alpha:1},9,cjs.Ease.get(1)).wait(318));

	// Logo_Love
	this.instance_1 = new lib.Logo_Love("synched",0);
	this.instance_1.setTransform(-66.5,544.2,0.8,0.8);
	this.instance_1.alpha = 0;
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(24).to({_off:false},0).to({x:89.5,alpha:1},9,cjs.Ease.get(0.58)).wait(327));

	// Logo2
	this.instance_2 = new lib.Logo2_1();
	this.instance_2.setTransform(21.25,442,0.9488,0.9488);
	this.instance_2.alpha = 0;
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(19).to({_off:false},0).to({regX:0.1,regY:0.1,x:116.2,y:442.1,alpha:1},9,cjs.Ease.get(1)).wait(332));

	// The_Subaru_A_Lot_to_Love_Event_
	this.instance_3 = new lib.F4();
	this.instance_3.setTransform(158.8,86.35,1.1196,1.1196);
	this.instance_3.alpha = 0;
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(289).to({_off:false},0).to({x:80.45,alpha:1},9,cjs.Ease.get(1)).wait(62));

	// Dog_tested__Dog_approved__
	this.instance_4 = new lib.F3();
	this.instance_4.setTransform(158.95,86.35,1.1196,1.1196);
	this.instance_4.alpha = 0;
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(194).to({_off:false},0).to({x:80.55,alpha:1},9,cjs.Ease.get(1)).to({_off:true},86).wait(71));

	// The_NEW_Subaru_Crosstrek_Hybrid
	this.instance_5 = new lib.F2();
	this.instance_5.setTransform(159,86.35,1.1196,1.1196);
	this.instance_5.alpha = 0;
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(119).to({_off:false},0).to({x:80.6,alpha:1},9,cjs.Ease.get(1)).to({_off:true},66).wait(166));

	// Up_to_597_miles_per_tank_
	this.instance_6 = new lib.F1();
	this.instance_6.setTransform(158.6,83.9,1.1196,1.1196);
	this.instance_6.alpha = 0;
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(9).to({_off:false},0).to({x:80.25,alpha:1},9,cjs.Ease.get(1)).to({_off:true},101).wait(241));
...
p.nominalBounds = new cjs.Rectangle(-143.2,0,369.6,600);


// stage content:
(lib.KSFY_220551_MM_160x600 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.ad_animatedLayers.setTransform(150,125.4,1,1,0,0,0,150,125);
...
p.nominalBounds = new cjs.Rectangle(-63.2,299.5,289.6,301);
// library properties:
lib.properties = {
	id: '4EC651F3C85F4D68813AB1FBD8E8CC81',
	width: 160,
	height: 600,
	fps: 30,
	color: "#FFFFFF",
...
an.compositions['4EC651F3C85F4D68813AB1FBD8E8CC81'] = {
