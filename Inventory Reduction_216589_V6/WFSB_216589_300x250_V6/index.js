...
if (reversed == null) { reversed = false; }
	...
	this.instance_4.setTransform(80,296);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(6).to({_off:false},0).to({y:300,alpha:1},14,cjs.Ease.get(1)).wait(142));
...
// stage content:
(lib.WFSB_216589_300x250_V6 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
